                            ...
                            <div class="row gx-5">
                              ...
                              <main class="col-lg-6 bg-white">
                                <div class="ps-lg-3">
                                  ...
                                  <h5 class = "sellerName">Ordered By : {{$order -> customer -> name}}</h5>
                                  <hr>
                                  <p>
                                      Address : <br>
                                  ...
                                  <hr>
                                    @switch($order -> status)
                                        @case(0)
                                            <p class = "text-primary">
                                                <button type = "button" class = "btn btn-outline-primary rounded-circle" onclick = "acceptOrder({{$order -> id}})">
                                    ...
                                    @endswitch
                                  <a href="{{route('seller.orders')}}" class = "btn btn-outline-dark">
    ...
    <script>
        ...
        function acceptOrder(id){
            $.ajax({
                    ...
                    url : '{{route('order.accept', $order -> id)}}',
                    method : 'get',
                    data : {
                        id : id,
                    },
